...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/notes/flexsearch.min.js');loadScript('/notes/en.search-data.min.f34423ffebccbdadea3af4a73297dccd4d77b6c3490a6cb3cbb2b9dbbe1a3fed.js',function(){input.required=false;search();});}
