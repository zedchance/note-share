...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/notes/flexsearch.min.js');loadScript('/notes/en.search-data.min.edfd042f6acbba55b21d6de965701f8b138e683b86d4dca62b2b4b41329f16fe.js',function(){input.required=false;search();});}
