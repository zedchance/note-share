...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/notes/flexsearch.min.js');loadScript('/notes/en.search-data.min.70ec90e7486d6731893578eb682c6b5822fc04509c0e667862d4d6fc74eb3eab.js',function(){input.required=false;search();});}
