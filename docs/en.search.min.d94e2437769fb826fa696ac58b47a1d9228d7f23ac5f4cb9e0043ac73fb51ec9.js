...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/notes/flexsearch.min.js');loadScript('/notes/en.search-data.min.cf993bffc2efb3575ebbc3c7d7d4c0e9d3d650c4df2e11b9f97838efbb6d372a.js',function(){input.required=false;search();});}
