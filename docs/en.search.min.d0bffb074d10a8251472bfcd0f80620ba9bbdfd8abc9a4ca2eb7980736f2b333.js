...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/notes/flexsearch.min.js');loadScript('/notes/en.search-data.min.06a5ecca30069760d4df16608276d91117e7c4cd75e1e097fa0c5b3cd1a4bdb3.js',function(){input.required=false;search();});}
