...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/notes/flexsearch.min.js');loadScript('/notes/en.search-data.min.828f0d08ffcb1b86593a59b19206ddb92f7b16a8d95da13b7e3356da92bb69cb.js',function(){input.required=false;search();});}
